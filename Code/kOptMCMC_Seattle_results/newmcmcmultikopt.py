...
if __name__ == "__main__":
    ...
    filepath = "newkoptmcmcmulti_seattle" 
    if isMultiSource:
    ...
    filepath = "newkoptmcmcmulti_seattle" + str(int(alpha*100))+"A" + str(num_iter) + "I" + str(int(lamda*100)) + "l"
    if isMultiSource:
        filepath = "newkoptmcmcmulti_seattlevirtual" + str(int(alpha*100))+"A" + str(num_iter) + "I" + str(int(lamda*100)) + "l"
