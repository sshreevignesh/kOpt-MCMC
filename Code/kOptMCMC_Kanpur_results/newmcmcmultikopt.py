...
if __name__ == "__main__":
    ...
    filepath = "newkoptmcmcmulti_kanpur" 
    if isMultiSource:
    ...
    filepath = "newkoptmcmcmulti_kanpur" + str(int(alpha*100))+"A" + str(num_iter) + "I" + str(int(lamda*100)) + "l"
    if isMultiSource:
        filepath = "newkoptmcmcmulti_kanpurvirtual" + str(int(alpha*100))+"A" + str(num_iter) + "I" + str(int(lamda*100)) + "l"
